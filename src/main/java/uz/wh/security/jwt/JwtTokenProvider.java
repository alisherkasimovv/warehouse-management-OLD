...
import uz.wh.security.JwtUserDetailsService;
...
public class JwtTokenProvider {
    ...
    /**
     * Check validity of token according to expiration time which is equal to 60 minutes
     * @param token Token of the user to check
     * @return Boolean value representing status of validation
     */
